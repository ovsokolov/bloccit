...
RSpec.describe User, type: :model do
  ...
  describe "invalid user" do
    ...
    #let(:user_with_invalid_email) { User.new(name: "Bloccit User", email: "userbloccit.com", password: "password") }
  ...
  describe "#favorite_for(post)" do
    ...
    it "returns `not nil` if user favorited the post" do
      expect(user.favorite_for(@post)).not_to be_nil
    end

    it "returns `nil` if user not favorited the post" do
      expect(another_user.favorite_for(@post)).to be_nil
    end
